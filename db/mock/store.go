...
// Source: github.com/marioTiara/api.simplebank.go/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TrasnferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
